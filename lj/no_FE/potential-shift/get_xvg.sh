...
parent_dir="/home/lindseywhitmore/projects/lennard-jones-miniproject/lj/no_FE/potential-shift/prod_out"

# Determine the directory where 'dhdl' folder will be created
dhdl_folder="/home/lindseywhitmore/projects/lennard-jones-miniproject/lj/no_FE/potential-shift/dhdl"
