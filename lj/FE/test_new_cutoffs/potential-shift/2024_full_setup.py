    ...
    try:
        ...
        for i in range(iterations):
            ...
            for lambda_state in range(lambda_states):
                ...
                commands = [
                    f"cd {lambda_dir}\n",
                    f"gmx_mpi grompp -f {lambda_mdp_file} -c {output_file} -p {top_file} -o modified_{i}_lambda_{lambda_state}.tpr\n",
                    f"gmx_mpi mdrun -s modified_{i}_lambda_{lambda_state}.tpr -dhdl dhdl_modified_{i}_lambda_{lambda_state}.xvg\n"
                ]
