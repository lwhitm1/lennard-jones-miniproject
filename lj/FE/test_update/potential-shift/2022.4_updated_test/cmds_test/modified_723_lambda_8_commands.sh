#!/bin/bash
cd /home/lindseywhitmore/projects/lennard-jones-miniproject/lj/FE/test_update/potential-switch/2022.4_updated_test/test_out/modified_723/lambda_8
...
gmx mdrun -nt 1 -s modified_723_lambda_8.tpr -dhdl dhdl_modified_723_lambda_8.xvg
