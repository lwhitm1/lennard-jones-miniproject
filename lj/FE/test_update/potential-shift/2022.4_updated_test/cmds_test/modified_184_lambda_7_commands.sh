#!/bin/bash
cd /home/lindseywhitmore/projects/lennard-jones-miniproject/lj/FE/test_update/potential-switch/2022.4_updated_test/test_out/modified_184/lambda_7
...
gmx mdrun -nt 1 -s modified_184_lambda_7.tpr -dhdl dhdl_modified_184_lambda_7.xvg
