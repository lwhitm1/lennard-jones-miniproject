#!/bin/bash
cd /home/lindseywhitmore/projects/lennard-jones-miniproject/lj/FE/test_update/potential-switch/2022.4_updated_test/test_out/modified_186/lambda_1
...
gmx mdrun -nt 1 -s modified_186_lambda_1.tpr -dhdl dhdl_modified_186_lambda_1.xvg
