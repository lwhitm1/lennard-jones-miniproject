#!/bin/bash
cd /home/lindseywhitmore/projects/lennard-jones-miniproject/lj/FE/test_update/potential-switch/2022.4_updated_test/test_out/modified_662/lambda_5
...
gmx mdrun -nt 1 -s modified_662_lambda_5.tpr -dhdl dhdl_modified_662_lambda_5.xvg
