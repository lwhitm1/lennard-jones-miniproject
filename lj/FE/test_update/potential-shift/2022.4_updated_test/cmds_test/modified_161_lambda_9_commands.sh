#!/bin/bash
cd /home/lindseywhitmore/projects/lennard-jones-miniproject/lj/FE/test_update/potential-switch/2022.4_updated_test/test_out/modified_161/lambda_9
...
gmx mdrun -nt 1 -s modified_161_lambda_9.tpr -dhdl dhdl_modified_161_lambda_9.xvg
