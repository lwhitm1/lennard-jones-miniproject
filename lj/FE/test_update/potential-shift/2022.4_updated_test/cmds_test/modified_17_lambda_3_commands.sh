#!/bin/bash
cd /home/lindseywhitmore/projects/lennard-jones-miniproject/lj/FE/test_update/potential-switch/2022.4_updated_test/test_out/modified_17/lambda_3
...
gmx mdrun -nt 1 -s modified_17_lambda_3.tpr -dhdl dhdl_modified_17_lambda_3.xvg
