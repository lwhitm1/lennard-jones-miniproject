#!/bin/bash
cd /home/lindseywhitmore/projects/lennard-jones-miniproject/lj/FE/test_update/potential-switch/2022.4_updated_test/test_out/modified_537/lambda_4
...
gmx mdrun -nt 1 -s modified_537_lambda_4.tpr -dhdl dhdl_modified_537_lambda_4.xvg
