#!/bin/bash
cd /home/lindseywhitmore/projects/lennard-jones-miniproject/lj/FE/test_update/potential-switch/2022.4_updated_test/test_out/modified_178/lambda_7
...
gmx mdrun -nt 1 -s modified_178_lambda_7.tpr -dhdl dhdl_modified_178_lambda_7.xvg
