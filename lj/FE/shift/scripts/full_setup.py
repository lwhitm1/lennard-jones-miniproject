    ...
    try:
        ...
        for i in range(iterations):
            ...
            for lambda_state in range(lambda_states):
                ...
                # Update the init_lambda_state line
                for index, line in enumerate(mdp_content):
                    if 'init_lambda_state' in line:
                        mdp_content[index] = f"init_lambda_state = {lambda_state}\n"
                        break
                ...
                # Debugging statement
                #print(f"Modified {lambda_mdp_file} with init_lambda_state = {lambda_state}")
